...
public class ParseController {
    ...
    public static OkHttpClient.Builder enableTls12OnPreLollipop(OkHttpClient.Builder
                                                                        client){
    ...
    public ParseController(Context act, HttpMethod method, Map<String, String> map,
                           boolean isShowLoading, String loadingMsg,
